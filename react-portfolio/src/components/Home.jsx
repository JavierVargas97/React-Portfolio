    ...
    return (
        <div name='home' className='w-full h-screen bg-[#10162f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <h1 className='text-4xl sm:text-7xl font-bold text-[#a2912f]'>Javier Vargas</h1>
                <h2 className='text-4xl sm:text-7xl font-semibold text-[#2f96b0]'>I'm a Full-Stack Developer </h2>
